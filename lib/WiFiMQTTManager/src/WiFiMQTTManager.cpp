...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 if (!wm->autoConnect(clientId, _APpassword)) {
  ...
  if (!client->connect(clientId, _mqtt_username, _mqtt_password)) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WiFiMQTTManager::_checkButton2() {
  // check for button press
  if ( digitalRead(_resetPin) == LOW ) {
    // poor mans debounce/press-hold, code not ideal for production
    delay(100);
    if( digitalRead(_resetPin) == LOW ){
      ...
      if( digitalRead(_resetPin) == LOW ){
        Serial.println("WMM: button held...");
        Serial.println("WMM: rede wifi habilitada!");
        wm->resetSettings();
        //ESP.restart();
	_teste = 2;
      }
